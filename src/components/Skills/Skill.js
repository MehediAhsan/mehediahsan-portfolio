...
const Skill = ({ skill }) => {
    ...
    return (
        <div className="relative group rounded-2xl w-24 h-24 overflow-hidden shadow-md hover:shadow-lg transition duration-300 ease-in-out cursor-pointer border border-gray-500 flex flex-col items-center justify-center p-4">
            <div className="flex justify-center items-center">
                <img className="w-12 h-12" src={img} alt={name} />
            </div>
