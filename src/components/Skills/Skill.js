...
const Skill = ({ skill }) => {
    ...
    return (
        <div className="relative group rounded-full h-28 w-28 overflow-hidden shadow-md hover:shadow-lg transition duration-300 ease-in-out cursor-pointer border border-primary flex flex-col items-center justify-center">
            <div className="flex justify-center items-center">
                <img className="w-14 h-14 p-2" src={img} alt={name} />
            </div>
