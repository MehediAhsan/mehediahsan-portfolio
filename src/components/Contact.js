	...
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x divide-gray-300">
		...
		<form ref={form} onSubmit={sendEmail} className="flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
			...
			<label className="block">
				...
				<textarea name='message' rows="3" className="block w-full rounded-md text-gray-800 border py-2 pl-2 border-gray-300" required></textarea>
			</label>
            <input type="submit" className="self-center px-5 py-2 text-lg rounded font-semibold bg-gray-700 text-gray-100 mt-8 cursor-pointer" value="Send" />
		</form>
