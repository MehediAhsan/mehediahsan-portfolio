        ...
        <div className="container m-auto px-6  md:px-12 lg:pt-[4.8rem] lg:px-10">
            <div className="flex flex-row items-center flex-wrap px-2">
                <div className="relative lg:w-5/12 xl:w-6/12 lg:py-14 xl:py-20">
                    <h1 className="font-semibold text-4xl text-slate-200 xl:text-5xl lg:w-10/12">
                        <Typewriter
                        options={{
                ...
                <div className="ml-auto">
                    <img src={photo} className="lg:w-96 relative rounded-full shadow-teal-400 drop-shadow-2xl border border-slate-300 p-3" alt="Mehedi" loading="lazy"/>
                </div>
            </div>
        </div>
    </div>
